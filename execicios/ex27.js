...
function calcularTempo (criança1 ,crescimentoAnual1, criança2, crescimentoAnual2){
    let anos = 0
    while (criança1 < criança2) {
        criança1 += crescimentoAnual1
        criança2 += crescimentoAnual2
        anos++
    } 
    return anos
}
